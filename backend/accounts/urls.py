...
from .views import RegisterView,LogoutView,UserProfileView,GoogleLoginView,PublicUserProfileView,FollowToggleView,UserSearchView,SendOTPView,VerifyOTPView, MyTokenObtainPairView
